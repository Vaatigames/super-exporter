...
class Metrics:
    ...
    players_online: List[int] = field(default_factory=list)
    players_max: List[int] = field(default_factory=list)
    version_name: List[str] = field(default_factory=list)
    version_protocol: List[int] = field(default_factory=list)
