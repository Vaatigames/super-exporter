...
class HTTPServer:
    def __init__(self, config: Config):
        ...
        self.metric_gauges = {
            ...
            "players_online": Gauge("pterodactyl_server_players_online", "Number of online players", label_names),
            "players_max": Gauge("pterodactyl_server_players_max", "Maximum number of players", label_names),
            "version_name": Gauge(
                "pterodactyl_server_version_name",
                "Minecraft server version name",
                label_names + ("version_name",)  # Add version_name as a label
            ),
            "version_protocol": Gauge(
                "pterodactyl_server_version_protocol",
                "Minecraft server protocol version",
                 label_names
           )
        }
